...
import edu.arizona.biosemantics.etcsite.core.shared.model.matrixgeneration.MatrixGenerationTaskStage;
import edu.arizona.biosemantics.etcsite.core.shared.model.ontologize.OntologizeTaskStage;
import edu.arizona.biosemantics.etcsite.core.shared.model.semanticmarkup.SemanticMarkupTaskStage;
import edu.arizona.biosemantics.etcsite.core.shared.model.taxonomycomparison.TaxonomyComparisonTaskStage;
import edu.arizona.biosemantics.etcsite.core.shared.model.treegeneration.TreeGenerationTaskStage;
...
public class TaskStageDAO {
	...
	private TaskStage createTaskStage(int id, String taskStage, TaskType taskType, Date created) {
		...
		case ONTOLOGIZE: 
			return new OntologizeTaskStage(id, taskType, created, edu.arizona.biosemantics.etcsite.core.shared.model.ontologize.TaskStageEnum.valueOf(taskStage));
		case MATRIX_GENERATION:
			return new MatrixGenerationTaskStage(id, taskType, created, edu.arizona.biosemantics.etcsite.core.shared.model.matrixgeneration.TaskStageEnum.valueOf(taskStage));
		case SEMANTIC_MARKUP:
			return new SemanticMarkupTaskStage(id, taskType, created, edu.arizona.biosemantics.etcsite.core.shared.model.semanticmarkup.TaskStageEnum.valueOf(taskStage));
		case TAXONOMY_COMPARISON:
			return new TaxonomyComparisonTaskStage(id, taskType, created, edu.arizona.biosemantics.etcsite.core.shared.model.taxonomycomparison.TaskStageEnum.valueOf(taskStage));
		case TREE_GENERATION:
			return new TreeGenerationTaskStage(id, taskType, created, edu.arizona.biosemantics.etcsite.core.shared.model.treegeneration.TaskStageEnum.valueOf(taskStage));
		case VISUALIZATION:
			break;
		default:
			break;
