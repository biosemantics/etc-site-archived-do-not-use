package edu.arizona.biosemantics.etcsite.core.server.log;
...
public class TraceInjection {
	...
	@Before("within(edu.arizona.biosemantics.etcsite.core.server..*) && "
			+ "!within(edu.arizona.biosemantics.etcsite.core.server.log..*) && "
			+ "!within(edu.arizona.biosemantics.etcsite.core.server.db.Query) && "
			+ "execution(public * *(..))")
