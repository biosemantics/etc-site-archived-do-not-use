package edu.arizona.biosemantics.etcsite.filemanager.server.log;
...
public class TraceInjection {
	...
	@Before("within(edu.arizona.biosemantics.etcsite.filemanager.server..*) && "
			+ "!within(edu.arizona.biosemantics.etcsite.filemanager.server.log..*) && "
			+ "execution(public * *(..))")
