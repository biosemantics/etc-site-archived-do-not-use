package edu.arizona.biosemantics.etcsite.common.server;
...
public class Configuration {
	...
	static {		
		try {
			...
			properties.load(loader.getResourceAsStream("edu/arizona/biosemantics/etcsite/common/config.properties"));
