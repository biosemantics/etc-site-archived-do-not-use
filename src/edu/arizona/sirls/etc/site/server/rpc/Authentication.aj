...
public class Authentication {
	...
	//@Around("execution(RPCResult edu.arizona.sirls.etc.site.server.rpc..*(..)) && args(authenticationToken, ..) && " +
	//		"!within(edu.arizona.sirls.etc.site.server.rpc.AuthenticationService) && !within(edu.arizona.sirls.etc.site.server.rpc.Authentication)")
	@Around("execution(RPCResult edu.arizona.sirls.etc.site.server.rpc..*(..)) && " +
			"!within(edu.arizona.sirls.etc.site.server.rpc.AuthenticationService) && !within(edu.arizona.sirls.etc.site.server.rpc.Authentication)")
