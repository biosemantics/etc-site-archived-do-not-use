...
import edu.arizona.sirls.etc.site.client.builder.lib.TaxonomyComparisonContentBuilder;
import edu.arizona.sirls.etc.site.client.builder.lib.matrixGeneration.MatrixGenerationContentBuilder;
import edu.arizona.sirls.etc.site.shared.rpc.AuthenticationResult;

public class TaxonomyComparisonClickHandler implements ClickHandler, IAuthenticationValidatorListener {
	...
	public void notify(AuthenticationResult authenticationResult) {
		...
		pageBuilder.setContentBuilder(TaxonomyComparisonContentBuilder.getInstance());
