...
public class MatrixGenerationClickHandler implements ClickHandler {
	...
	private AsyncCallback<AuthenticationResult> validSessionCallback = new AsyncCallback<AuthenticationResult>() {
		public void onSuccess(AuthenticationResult authenticationResult) {
			...
			pageBuilder.setContentBuilder(new MatrixGenerationContentBuilder(new InputStepBuilder(new MatrixGenerationJob())));
