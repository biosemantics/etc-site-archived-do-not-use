...
public class VisualizationClickHandler implements ClickHandler, IAuthenticationValidatorListener {
	...
	public void notify(AuthenticationResult authenticationResult) {
		...
		pageBuilder.setContentBuilder(VisualizationContentBuilder.getInstance());
