 ...
 */
public class MyActivityManager extends ActivityManager implements PlaceChangeEvent.Handler,
	...
	private class ProtectedDisplay implements AcceptsOneWidget {
		...
		ProtectedDisplay(MyActivity activity) {
	...
	private static final MyActivity NULL_ACTIVITY = new MyAbstractActivity(null, null, null, null, null) {
		@Override
		public void update() {
		}
		@Override
	...
	private MyActivity currentActivity = NULL_ACTIVITY;
	 ...
	 */
	public MyActivityManager(MyActivityMapper mapper, EventBus eventBus) {
	...
	public void onPlaceChange(PlaceChangeEvent event) {
		MyActivity nextActivity = getNextActivity(event);
	...
	private MyActivity getNextActivity(PlaceChangeEvent event) {
		if (display == null) {
			/*
