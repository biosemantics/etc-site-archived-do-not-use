...
public class OntologizeInputPresenter implements IOntologizeInputView.Presenter {
	...
	@Inject
	public OntologizeInputPresenter(IOntologizeInputView view, 
	...
	@Override
	public IOntologizeInputView getView() {
		return view;
	}
