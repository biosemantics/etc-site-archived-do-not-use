...
public class FileTreeDecorator {
	...
	public Map<String, FileImageLabelTreeItem> decorate(IFileTreeView view, 
			edu.arizona.biosemantics.etcsite.shared.model.file.Tree<FileInfo> fileTree, FileFilter fileFilter, 
		...
		if(fileTree.getValue().getFileType().equals(FileTypeEnum.DIRECTORY)) {
			for(edu.arizona.biosemantics.etcsite.shared.model.file.Tree<FileInfo> child : fileTree.getChildren()) {
	...
	private void decorate(IFileTreeView view, TreeItem root, edu.arizona.biosemantics.etcsite.shared.model.file.Tree<FileInfo> fileTree, FileFilter fileFilter, 
