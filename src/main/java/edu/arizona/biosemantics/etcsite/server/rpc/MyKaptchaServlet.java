...
public class MyKaptchaServlet extends HttpServlet implements Servlet
{
			...
			throws ServletException, IOException
	{
		...
		//System.out.println("Got a captcha request with url: " + url);
		String idStr = url.substring(url.lastIndexOf(File.separator)+1);
		int id = Integer.parseInt(idStr);
		//System.out.println("Has id: " + id);
		String newURL = CaptchaManager.getInstance().getURLFor(id);
		//System.out.println("The CaptchaManager says it is here: " + newURL);
