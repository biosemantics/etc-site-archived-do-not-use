...
public class TitleCloseDialogBox extends DecoratedPopupPanel implements HasHTML, HasSafeHtml, MouseListener {
  /**
   ...
   */
  /*public static class MyCaption extends HTML implements Caption {
  ...
  private class MouseHandler implements MouseDownHandler, MouseUpHandler,
    ...
    public void onMouseOut(MouseOutEvent event) {
      TitleCloseDialogBox.this.onMouseLeave(caption.asWidget());
    }

    public void onMouseOver(MouseOverEvent event) {
      TitleCloseDialogBox.this.onMouseEnter(caption.asWidget());
    }
...
private ICancelConfirmHandler cancelConfirmHandler;
   ...
   */
  public TitleCloseDialogBox(String title) {
    this(false, title);
  }
   ...
   */
  public TitleCloseDialogBox(boolean autoHide, String title) {
    this(autoHide, true, title);
  }
   ...
   */
/*  public MyDialogBox(boolean autoHide, boolean modal, String title) {
    this(autoHide, modal, title);
  }*/
   ...
   * @param captionWidget the widget that is the DialogBox's header.
   */
  public TitleCloseDialogBox(boolean autoHide, boolean modal, String title) {
    super(autoHide, modal, "dialog");
    TitleCloseCaption captionWidget = new TitleCloseCaption(title, this);
